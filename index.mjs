...
const serviceBoundariesParams = {
    settings: {
        elements: [
            ...
            {
                type: 'externalEventListeners',
                pattern: 'src/externalEventListeners/*.ts',
                mode: 'file',
                capture: ['eventName'],
            },
            {
                type: 'workerWorkflowsTypes',
                pattern: 'src/worker/workflows/**/*.types.ts',
                mode: 'file',
            },
            {
                type: 'workerWorkflows',
                pattern: 'src/worker/workflows/**',
            },
            {
                type: 'workerActivities',
                pattern: 'src/worker/activities/**',
            },
            {
                type: 'workerSchedules',
                pattern: 'src/worker/schedules/**',
            },
            {
                type: 'worker',
                pattern: 'src/worker/**',
